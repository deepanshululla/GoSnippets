...
// instance. A lifecycle configuration is a collection of shell main that
// run when you create or start a notebook instance.
//
// Each lifecycle configuration script has a limit of 16384 characters.
//
// The value of the $PATH environment variable that is available to both main
...
//
// Lifecycle configuration main cannot run for longer than 5 minutes. If
